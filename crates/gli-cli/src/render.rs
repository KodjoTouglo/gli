...
use gli_core::{Change, Module, Report, State, Status};
...
pub fn summary(total_changes: usize) {
    ...
    match total_changes {
        ...
        1 => println!("1 change pending. Run `gli apply` to converge."),
        n => println!("{n} changes pending. Run `gli apply` to converge."),
    }
}
